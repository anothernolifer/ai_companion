...
import 'package:friend/provider/boy_video_provider.dart';
...
class BoyVideoScreen extends ConsumerStatefulWidget {
  @override
  _BoyVideoScreenState createState() => _BoyVideoScreenState();
}

class _BoyVideoScreenState extends ConsumerState<BoyVideoScreen>
  ...
  void initState() {
    ...
    _videoController = VideoPlayerController.asset('assets/boy_video.mp4')
      ..initialize().then((_) {
        setState(() {});
      });
